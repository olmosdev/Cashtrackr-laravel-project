...
class ExpenseRequest extends FormRequest
{
    ...
    public function authorize(): bool
    {
        ...
        // Do the budget and the user exist?
        // Only the user with permission to update the budget can submit a request.
    ...
    {
        // Identify the source of the request and retrieve the quote from the URL.
        $budget = $this->route('budget');
